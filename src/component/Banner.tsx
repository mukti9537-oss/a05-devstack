        ...
        <section className="container max-w-7xl mx-auto py-5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div className="max-w-xl" >
                    ...
                    <span className="bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mt-0.5"> Development Stack</span> </h1>
                    ...
                    <div className="mt-7 flex gap-3">
                        <button className=" bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 ... rounded-2xl px-5 py-2 text-white active:scale-90
